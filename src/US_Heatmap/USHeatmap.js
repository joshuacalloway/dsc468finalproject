...
import styled from 'styled-components';
    ...
    const USHeatmap = () => {
      ...
      const covidUrl = 'https://api.covid19api.com/country/US/status/confirmed?from=2020-03-01T00:00:00Z&to=2020-04-01T00:00:00Z';
        ...
        fetch(covidUrl, requestOptions)
          ...
          .then(data => {
            ...
            if (errorMessage) {
              ...
              console.log(data);
              setCovidResult(data[0].Country);
            }
          });
      }
      return <StyledDiv>
        <h1>Calling heat map{covidUrl}</h1>
        
        <div className="blinking">
            Covid Result: {covidResult}
        </div>
    </StyledDiv>;
